    ...
    companion object {
        ...
        fun fromDCObject(dcConsultation: DCResource): Consultation =
            Consultation(
                ...
                finaliteMarche = FinaliteMarcheType.valueOf(
                    dcConsultation.getStringValue("mpconsultation:finaliteMarche")),
                typeMarche = TypeMarcheType.valueOf(dcConsultation.getStringValue("mpconsultation:typeMarche")),
                typePrestation = TypePrestationType.valueOf(
                    dcConsultation.getStringValue("mpconsultation:typePrestation")),
                ...
                etat = if (!dcConsultation.getStringValue("mpconsultation:etat").isEmpty()) Etat.valueOf(
                    dcConsultation.getStringValue(
                        "mpconsultation:etat"
                    )
                ) else
                    if ((dcConsultation.getDateValue("mpconsultation:dateCloture")).isAfter(
                            LocalDateTime.now())) Etat.CREATED else Etat.CLOSED
            )
    }
}
