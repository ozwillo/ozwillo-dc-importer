...
import org.ozwillo.dcimporter.service.EgmService
...
class EgmReceiver (private val egmService: EgmService) {
            ...
            routingBindingKeyOfAction(routingKey, BindingKeyAction.CREATE) ->
                when {
                    routingBindingKeyOfType(routingKey, elecmeetingType) -> {
                        ...
                        egmService.createCitizenRequest(routingBindingKeySiret(routingKey), resource)
                    }
