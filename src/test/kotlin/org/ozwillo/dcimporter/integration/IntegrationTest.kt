package org.ozwillo.dcimporter.integration
...
class IntegrationTest(
    ...
    fun `correct subvention creation with organization unknown from dc`() {
        ...
        assertEquals(0, WireMock.findUnmatchedRequests().size)

        WireMock.verify(1, RequestPatternBuilder().withUrl("/dc/type/orgfr:Organisation_0/FR/$siret"))
        WireMock.verify(1, RequestPatternBuilder().withUrl("/dc/type/orgfr:Organisation_0/FR/$grantedSiret"))
    }
