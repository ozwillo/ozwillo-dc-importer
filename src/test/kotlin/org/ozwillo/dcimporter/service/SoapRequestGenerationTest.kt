...
class SoapRequestGenerationTest {
    ...
    fun correct_consultation_update_request_generation_test() {
        ...
        val request = MSUtils.generateModifyConsultationLogRequest(
            login,
            password,
            pa,
            dce,
    ...
    fun correct_lot_update_request_generation_test() {
        ...
        val request =
            MSUtils.generateModifyLotRequest(login, password, pa, dce, cleLot, libelleLot, ordreLot, numeroLot)
        assertThat(request).isEqualTo(goodRequest)
    }
    ...
    fun correct_piece_creation_request_generation_test() {
        ...
        val request = MSUtils.generateCreatePieceLogRequest(
            login,
            password,
            pa,
            dce,
    ...
    fun correct_update_piece_request_generation_test() {
        ...
        val request = MSUtils.generateModifyPieceLogRequest(
            login,
            password,
            pa,
            dce,
    ...
    fun `correct listing e_response request generation test`() {
        ...
        val request =
            MSUtils.generateListRegistreReponseRequest(login, password, msReference, ordre, sensOrdre.toString())
        assertThat(request).isEqualTo(goodRequest)
    }
    ...
    fun `correct listing e_retrait request generation test`() {
        ...
        val request =
            MSUtils.generateListRegistreRetraitRequest(login, password, msReference, ordre, sensOrdre.toString())
        assertThat(request).isEqualTo(goodRequest)
    }
